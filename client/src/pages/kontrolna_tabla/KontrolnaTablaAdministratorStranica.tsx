...
interface KontrolaTavlaAdministratorStranicaProps {
    usersApi: IUsersAPIService;
}

export default function KontrolaTablaAdministratorStranica({ usersApi }: KontrolaTavlaAdministratorStranicaProps){
